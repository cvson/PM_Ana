...
int main(int argc,char *argv[]){
  ...
  //#########################################
  sprintf(FileName,"/home/t2kingrid/INGRID_analysis/app/sample.root");
 
  
  if( !MC&&filenum ){
    sprintf(AddFile,"/home/t2kingrid/data/dst/ingrid_%08d_%04d_calib.root",
	    run_number, sub_run_number);

    sprintf(NewFile,"/home/t2kingrid/data/dst/ingrid_%08d_%04d_form.root",
	    run_number, sub_run_number);
  }
  ...
  for(int ievt = 0; ievt < nevt2; ++ievt){
	...
	*/
	...
	//beaminfo   = (BeamInfoSummary*) (asummary -> GetBeamSummary(0) );
	//wsummary   -> AddBeamSummary(beaminfo);
