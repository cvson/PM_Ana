...
void out(){
  ...
  */
  ...
  c1->Print("evtrate.C");
  */
  ofstream outfile("pileup.txt");

  for(int mod=0;mod<14;mod++){
    /*
    outfile<<"*****Module"<<mod<<"*****"<<endl;
    outfile<<"pile    :"<<(case111[mod]+case110[mod])<<endl;
    outfile<<"decrease:"<<(-case001[mod]+case100[mod]+case010[mod]+case111[mod]+2*case110[mod])<<endl;
    outfile<<"case001 :"<<case001[mod]<<endl;
    outfile<<"case100 :"<<case100[mod]<<endl;
    outfile<<"case010 :"<<case010[mod]<<endl;
    outfile<<"case111 :"<<case111[mod]<<endl;
    outfile<<"case110 :"<<case110[mod]<<endl;
    outfile<<endl;
    */
    outfile<<"*****Module"<<mod<<"*****"<<endl;
    outfile<<(case111[mod]+case110[mod])<<endl;
    outfile<<(-case001[mod]+case100[mod]+case010[mod]+case111[mod]+2*case110[mod])<<endl;
    outfile<<case001[mod]<<endl;
    outfile<<case100[mod]<<endl;
    outfile<<case010[mod]<<endl;
    outfile<<case111[mod]<<endl;
    outfile<<case110[mod]<<endl;
    outfile<<endl;
