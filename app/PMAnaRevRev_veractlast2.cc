...
int main(int argc,char *argv[]){
  ...
  for(int ievt=Nini; ievt<nevt; ievt++){
	...
	/*
	int xpln  = pmtrack[i].trk[0].endxpln;
	int ypln  = pmtrack[i].trk[0].endypln;
	float xch = pmtrack[i].trk[0].endxch;
	float ych = pmtrack[i].trk[0].endych;
	*/

	
	if(pmtrack[i].Ntrack>1){
	  xpln  = pmtrack[i].trk[1].endxpln;
	  ypln  = pmtrack[i].trk[1].endypln;
	  xch = pmtrack[i].trk[1].endxch;
	  ych = pmtrack[i].trk[1].endych;
	}
	else{
	  xpln  = pmtrack[i].trk[0].endxpln;
	  ypln  = pmtrack[i].trk[0].endypln;
	  xch = pmtrack[i].trk[0].endxch;
	  ych = pmtrack[i].trk[0].endych;
	}
