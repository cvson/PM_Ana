...
int main(int argc,char *argv[]){
  ...
  if( !MC ){
    ...
    sprintf(NewFile1,"/home/ingrid/scraid0/kikawa/pile/new/ingmc_10d_numu_fe_nd%d_%d_%d.root",
	    run_number, sub_run_number, sub_run_number2);
    sprintf(NewFile2,"/home/ingrid/scraid0/kikawa/pile/old1/ingmc_10d_numu_fe_nd%d_%d_%d.root",
	    run_number, sub_run_number, sub_run_number2);
    sprintf(NewFile3,"/home/ingrid/scraid0/kikawa/pile/old2/ingmc_10d_numu_fe_nd%d_%d_%d.root",
	    run_number, sub_run_number, sub_run_number2);
  }
    ...
    //sprintf(FileName,"/home/akira.m/scraid0/INGRID_MC/10d/numu/ingmc/ingmc_10d_numu_fe_nd%d_%d.root",
    sprintf(FileName,"/home/ingrid/scraid0/kikawa/bgmc/nd7_nd%d_10c_rock_%d.root",
	    run_number, sub_run_number);
