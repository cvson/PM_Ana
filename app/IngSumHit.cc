...
int main(int argc,char *argv[]){
  ...
  if( !MC ){
    ...
    sprintf(NewFile1,"/home/kikawa/scraid1/pile/new/ingmc_10d_numu_fe_nd%d_%d_%d.root",
	    run_number, sub_run_number, sub_run_number2);
    sprintf(NewFile2,"/home/kikawa/scraid1/pile/old1/ingmc_10d_numu_fe_nd%d_%d_%d.root",
	    run_number, sub_run_number, sub_run_number2);
    sprintf(NewFile3,"/home/kikawa/scraid1/pile/old2/ingmc_10d_numu_fe_nd%d_%d_%d.root",
	    run_number, sub_run_number, sub_run_number2);
  }
